...
<div class="main-content-row">
	<div class="container clearfix">
		...
		<?php include_once('template-parts/sidebar-data.php'); ?>
		...
		<div class="main-content the-content">
			...
			?>
					...
					<tbody>
						<?php while ($hasil = $query->fetch()) : ?>
							<tr>
								...
								<td><a href="single-data.php?id=<?php echo $hasil['id_kambing']; ?>"><span class="fa fa-eye"></span> Detail</a></td>
								<td><a href="edit-data.php?id=<?php echo $hasil['id_kambing']; ?>"><span class="fa fa-pencil"></span> Edit</a></td>
								<td><a href="hapus-data.php?id=<?php echo $hasil['id_kambing']; ?>" class="red yaqin-hapus"><span class="fa fa-times"></span> Hapus</a></td>
							</tr>
						<?php endwhile; ?>
					</tbody>
				</table>
				...
				<table class="pure-table pure-table-striped">
					<thead>
						<tr class="super-top">
							<th rowspan="2" class="super-top-left">No. Data</th>
