...
if (isset($_POST['submit'])) :
	...
	// Validasi
	if (!$no_kalung) {
		$errors[] = 'Nomor tidak boleh kosong';
	}
	if (!$tanggal_input) {
	...
	if (empty($errors)) :
		...
		redirect_to('list-data.php?status=sukses-edit');
	...
	<div class="container clearfix">
		...
		<div class="main-content the-content">
			...
			<?php else : ?>
				...
				<form action="edit-data.php?id=<?php echo $id_kambing; ?>" method="post">
					<div class="field-wrap clearfix">
						<label>Nomor Data <span class="red">*</span></label>
					...
					<div class="field-wrap clearfix">
						<button type="submit" name="submit" value="submit" class="button">Simpan Data</button>
					</div>
				</form>
