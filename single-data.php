	...
	<div class="container clearfix">
		...
		<div class="main-content the-content">
			...
			<?php elseif (!empty($result)) : ?>
				...
				<p><a href="edit-data.php?id=<?php echo $id_kambing; ?>" class="button"><span class="fa fa-pencil"></span> Edit</a> &nbsp; <a href="hapus-data.php?id=<?php echo $id_kambing; ?>" class="button button-red yaqin-hapus"><span class="fa fa-times"></span> Hapus</a></p>
